...
{
    if (std::strcmp(source_text, "Restore") == 0 || std::strcmp(source_text, "Restored") == 0)
    {
...
VpChineseUiTranslator::VpChineseUiTranslator(QObject* parent) : QTranslator(parent)
{
}

QString VpChineseUiTranslator::translate(const char* context, const char* source_text,
