...
std::vector<SPoint2d> splineApproximation(const SSplineEntity& spline, int segment_count)
{
...
double splineApproximateLength(const SSplineEntity& spline, int segment_count)
{
    const std::vector<SPoint2d> points = splineApproximation(spline, segment_count);
    double result = 0.0;
