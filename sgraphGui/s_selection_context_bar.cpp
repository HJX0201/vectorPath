...
void SSelectionContextBar::addAction(QAction* action)
{
...
void SSelectionContextBar::addSeparator()
{
...
void SSelectionContextBar::popupAt(const QPoint& global_position)
{
    adjustSize();
