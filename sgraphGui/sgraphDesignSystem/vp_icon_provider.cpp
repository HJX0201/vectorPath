...
#include "vp_file_icon.h"
#include "vp_import_icon.h"
...
QIcon VpIconProvider::createIcon(VpIconType icon_type, const QColor& foreground,
                                 const QColor& accent)
{
    ...
    case VpIconType::SaveAs:
        ...
        if (icon_type == VpIconType::SaveAs)
        {
    ...
    {
        const bool is_redo = icon_type == VpIconType::Redo;
    ...
    case VpIconType::SpeedDown:
        ...
        painter.setPen(QPen(accent_color, 4.0));
        painter.drawLine(QPointF(32, 32), QPointF(icon_type == VpIconType::SpeedUp ? 47 : 20, 20));
        break;
