...
bool drawImportIcon(QPainter& painter, VpIconType icon_type, const QColor& foreground,
                    const QColor& accent)
{
    if (icon_type != VpIconType::ImportSvg && icon_type != VpIconType::ImportBitmap &&
        icon_type != VpIconType::SvgFill && icon_type != VpIconType::SvgDeduplicate)
    {
        return false;
    }
    QPainterPath file;
    ...
    if (icon_type == VpIconType::ImportSvg)
    {
    ...
    else if (icon_type == VpIconType::ImportBitmap)
    {
    ...
    else if (icon_type == VpIconType::SvgFill)
    {
