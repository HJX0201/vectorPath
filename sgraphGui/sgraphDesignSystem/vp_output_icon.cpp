...
{
    if (icon_type == VpIconType::PageSetup)
    {
    ...
    else if (icon_type == VpIconType::PlotStyle)
    {
    ...
    else if (icon_type == VpIconType::PlotPreview)
    {
    ...
    else if (icon_type == VpIconType::Print)
    {
    ...
    else if (icon_type == VpIconType::ExportPdf)
    {
