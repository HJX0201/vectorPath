...
VpProxyStyle::VpProxyStyle() : QProxyStyle(QStyleFactory::create(QStringLiteral("Fusion")))
{
}

int VpProxyStyle::pixelMetric(PixelMetric metric, const QStyleOption* option,
...
QSize VpProxyStyle::sizeFromContents(ContentsType type, const QStyleOption* option,
