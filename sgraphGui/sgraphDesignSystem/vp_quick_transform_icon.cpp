...
void drawQuickTransformIcon(QPainter& painter, VpIconType icon_type, const QColor& foreground,
                            const QColor& accent)
{
    if (icon_type == VpIconType::QuickReverse)
    {
    ...
    if (icon_type == VpIconType::MirrorVertical || icon_type == VpIconType::MirrorHorizontal)
    {
        const bool vertical = icon_type == VpIconType::MirrorVertical;
    ...
    const bool clockwise =
        icon_type == VpIconType::RotateClockwise90 || icon_type == VpIconType::RotateClockwise180;
    const bool half_turn = icon_type == VpIconType::RotateClockwise180 ||
                           icon_type == VpIconType::RotateCounterclockwise180;
