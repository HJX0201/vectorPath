...
void VpCadMainWindow::executeCommand(const QString& command)
{
    ...
    {
        m_workspace->viewport()->setToolMode(VpToolMode::Erase);
    }
    ...
    {
        m_workspace->viewport()->setToolMode(VpToolMode::AlignedDimension);
    }
    else if (normalized == QLatin1String("DIMANGULAR") || normalized == QLatin1String("DAN"))
    {
        m_workspace->viewport()->setToolMode(VpToolMode::AngularDimension);
    }
    else if (normalized == QLatin1String("DIMRADIUS") || normalized == QLatin1String("DRA"))
    {
        m_workspace->viewport()->setToolMode(VpToolMode::RadiusDimension);
    }
    else if (normalized == QLatin1String("DIMDIAMETER") || normalized == QLatin1String("DDI"))
    {
        m_workspace->viewport()->setToolMode(VpToolMode::DiameterDimension);
    }
    else if (normalized == QLatin1String("DIMARC") || normalized == QLatin1String("DAR"))
    {
        m_workspace->viewport()->setToolMode(VpToolMode::ArcLengthDimension);
    }
    else if (normalized == QLatin1String("DIMORDINATE") || normalized == QLatin1String("DOR"))
    {
        m_workspace->viewport()->setToolMode(VpToolMode::OrdinateDimension);
    }
    ...
    else if (normalized == QLatin1String("IMPORTSVG") || normalized == QLatin1String("SVGIMPORT"))
    {
