...
void VpCadMainWindow::showInterfaceSettings()
{
...
void VpCadMainWindow::applyUiScale(int scale_percent)
{
    ...
    if (auto* drawing_toolbar = findChild<QToolBar*>(QStringLiteral("smartDrawingToolBar")))
    {
