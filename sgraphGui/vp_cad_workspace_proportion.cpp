...
void VpCadMainWindow::applyDefaultWorkspaceProportions()
{
    ...
    QSplitter* inspector_splitter = sharedSplitter(m_dock_manager, m_workspace, m_layer_dock);
    setChildProportion(inspector_splitter, m_layer_dock, 0.20);

    QSplitter* command_splitter = sharedSplitter(m_dock_manager, m_workspace, m_command_dock);
