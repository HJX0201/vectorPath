...
VpCadWorkspaceWidget::VpCadWorkspaceWidget(QWidget* parent) : QWidget(parent)
{
    ...
    m_viewport = new VpCadViewport(m_document_tabs);
...
void VpCadWorkspaceWidget::setDocument(VpCadDocument* document)
{
    if (m_document)
    {
...
void VpCadWorkspaceWidget::applyUiScale(int scale_percent)
{
...
VpCadViewport* VpCadWorkspaceWidget::viewport() const noexcept
{
    return m_viewport;
}

QToolBar* VpCadWorkspaceWidget::quickOperationBar() const noexcept
{
    return m_quick_operation_bar;
}

void VpCadWorkspaceWidget::updateDocumentTitle()
{
    if (!m_document)
    {
        return;
