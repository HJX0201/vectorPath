...
VpDialog::VpDialog(QWidget* parent) : QDialog(parent)
{
    setMinimumSize(kStandardDialogMinimumWidth, kStandardDialogMinimumHeight);
}

QString VpDialogService::getText(QWidget* parent, const QString& title, const QString& label,
...
QString VpDialogService::getItem(QWidget* parent, const QString& title, const QString& label,
...
QMessageBox::StandardButton VpDialogService::information(QWidget* parent, const QString& title,
                                                         const QString& text,
...
QMessageBox::StandardButton VpDialogService::warning(QWidget* parent, const QString& title,
                                                     const QString& text,
                                                     QMessageBox::StandardButtons buttons,
                                                     QMessageBox::StandardButton default_button)
{
...
QMessageBox::StandardButton VpDialogService::critical(QWidget* parent, const QString& title,
                                                      const QString& text,
                                                      QMessageBox::StandardButtons buttons,
                                                      QMessageBox::StandardButton default_button)
{
...
QMessageBox::StandardButton VpDialogService::question(QWidget* parent, const QString& title,
                                                      const QString& text,
                                                      QMessageBox::StandardButtons buttons,
                                                      QMessageBox::StandardButton default_button)
{
...
QMessageBox::StandardButton VpDialogService::showMessage(QMessageBox::Icon icon, QWidget* parent,
