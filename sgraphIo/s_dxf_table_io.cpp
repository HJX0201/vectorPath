...
int layerTransparency(const std::vector<SDxfPair>& record)
{
...
SLayerRecord readLayerRecord(const std::vector<SDxfPair>& record)
{
    SLayerRecord layer;
