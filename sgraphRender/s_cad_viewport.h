...
class SCadViewport final : public QOpenGLWidget, protected QOpenGLFunctions
{
  ...
  signals:
    void cursorWorldPositionChanged(const smartGraphics::SPoint2d& world_position);
    void commandMessage(const QString& message);
    void toolModeChanged(smartGraphics::SToolMode tool_mode);
    ...
    void gripOperationChanged(smartGraphics::SGripOperation operation);
