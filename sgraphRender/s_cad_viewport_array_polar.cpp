...
void SCadViewport::setPolarArrayParameters(int item_count, double fill_angle)
{
...
void SCadViewport::acceptPolarArrayPoint(const SPoint2d& world_point)
{
...
void SCadViewport::drawPolarArrayPreview(QPainter& painter)
{
    ...
    const std::vector<SEntityRecord> previews = polarArrayEntities(
