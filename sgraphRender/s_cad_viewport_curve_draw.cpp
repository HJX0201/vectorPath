...
void SCadViewport::acceptEllipsePoint(const SPoint2d& world_point)
{
    ...
    else
    {
        ...
        const SPoint2d major_axis{m_input_points[1].x - center.x, m_input_points[1].y - center.y};
        ...
        {
            const SPoint2d minor_axis{-major_axis.y * minor_length / major_length,
...
void SCadViewport::acceptSplinePoint(const SPoint2d& world_point)
{
    m_input_points.push_back(world_point);
    ...
    {
        const std::array<SPoint2d, 4> control_points{m_input_points[0], m_input_points[1],
