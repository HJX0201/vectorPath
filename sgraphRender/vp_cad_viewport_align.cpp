...
{
    VpEntityRecord result = translatedEntity(source, first_target_point.x - first_source_point.x,
...
void VpCadViewport::acceptAlignPoint(const VpPoint2d& world_point)
{
...
void VpCadViewport::drawAlignPreview(QPainter& painter)
{
