...
void VpCadViewport::setRectangularArrayCounts(int column_count, int row_count)
{
...
void VpCadViewport::acceptRectangularArrayPoint(const VpPoint2d& world_point)
{
...
void VpCadViewport::drawRectangularArrayPreview(QPainter& painter)
{
    ...
    const std::vector<VpEntityRecord> previews = rectangularArrayEntities(
