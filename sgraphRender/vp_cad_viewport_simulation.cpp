...
VpPoint2d VpCadViewport::visibleWorldBottomLeft() const
{
    return screenToWorld(QPointF(0.0, height()));
}

void VpCadViewport::setSimulationOverlay(std::vector<VpToolpathMotion> motions,
...
void VpCadViewport::clearSimulationOverlay()
{
...
void VpCadViewport::drawSimulationOverlay(QPainter& painter)
{
    ...
    {
        const VpToolpathMotion& motion = m_simulation_motions[index];
        ...
        if (motion.type == VpToolpathMotionType::Rapid)
        {
